...
%% Unfolding of the volume in the plane
...
%% Volume visualization (with normali)
...
%% DIRECT CLOSING OF HOLES 
% se fai questo passare direttamente a %% Salva e visualizza il nuovo file STL ricostruito
...
%% Upper surface insulation MODE1 
% (elimino facce di base)
...
%% Upper surface insulation MODE2 
% (mantiene solo le facce superiori orizzontali)
...
%% Reconstruction of the volume starting from the upper surface 1 
% (per superfici semplici, senza troppi buchi)
...
%% Reconstruction of the volume starting from the upper surface 2 
% (per superfici complesse, con trama)
...
%% Save and view the reconstructed STL file 
...
%% Import of the trajectory txt file
...
%% Printer coordinates: mm-ROTATION
...
%% Printer coordinates: deg(°)-ROTATION
